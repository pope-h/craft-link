  ...
  return (
    ...
    >
      ...
      <div className="flex gap-x-2 flex-wrap">
        ...
        <span className="px-2 border-l text-xs md:text-base border-[#FCFBF726] flex items-center gap-x-2  max-sm:py-2">
          <div className={`${ job.status === "ended" ? " bg-[#980F0F]" : "bg-[#04DF76]"} max-sm:px-2 h-4 w-4 self-center rounded-full`}></div>
          {job?.statusMsg}
        </span>
